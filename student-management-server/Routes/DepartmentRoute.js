...
departmentRouter.post("/department", isAuth, async (req, res) => {
  try {
...
// delete a department
departmentRouter.delete("/:departmentId", isAuth, async (req, res) => {
  try {
...
departmentRouter.put("/:departmentId", isAuth, async (req, res) => {
  try {
